...
----
If the lock is not acquired within the timeout, the operation will fail with an appropriate error message. This reduces the need for users to implement custom retry logic.
link:https://issues.apache.org/jira/browse/HBASE-19441[HBASE-19441]
