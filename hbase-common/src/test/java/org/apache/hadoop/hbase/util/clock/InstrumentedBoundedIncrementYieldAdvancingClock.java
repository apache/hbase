...
public class InstrumentedBoundedIncrementYieldAdvancingClock
    extends BoundedIncrementYieldAdvancingClock {

  static final Logger LOG =
    LoggerFactory.getLogger(InstrumentedBoundedIncrementYieldAdvancingClock.class);
  final LongAdder countOk = new LongAdder();
  final LongAdder countAdvance = new LongAdder();
  final LongAdder countYields = new LongAdder();

  public InstrumentedBoundedIncrementYieldAdvancingClock(HashedBytes name) {
    super(name);
  }
  ...
  public boolean remove() {
    ...
    LOG.debug("{}: ok={}, advanced={}, yields={}", getName(), countOk.longValue(),
      countAdvance.longValue(), countYields.longValue());
    return result;
  }
