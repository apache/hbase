...
public class TAppend implements org.apache.thrift.TBase<TAppend, TAppend._Fields>,
  ...
  public TAppend(java.nio.ByteBuffer row, java.util.List<TColumnValue> columns) {
    this();
  ...
  public TAppend(TAppend other) {
    ...
    if (other.isSetColumns()) {
      java.util.List<TColumnValue> __this__columns =
          new java.util.ArrayList<TColumnValue>(other.columns.size());
  ...
  public TAppend
      setColumns(@org.apache.thrift.annotation.Nullable java.util.List<TColumnValue> columns) {
    this.columns = columns;
    return this;
  }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter96 : struct.attributes
                .entrySet()) {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter98 : struct.attributes
              .entrySet()) {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.attributes =
              new java.util.HashMap<java.nio.ByteBuffer, java.nio.ByteBuffer>(2 * _map102.size);
          @org.apache.thrift.annotation.Nullable
