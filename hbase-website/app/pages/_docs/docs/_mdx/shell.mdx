---
title: "The Apache HBase Shell"
description: "Guide to using the HBase Shell including scripting, tricks, and advanced features."
---
...
See [shell exercises](#shell-exercises) for example basic shell operation.
...
You can pass commands to the HBase Shell in non-interactive mode (see [hbase.shell.noninteractive](#hbaseshellnoninteractive)) using the `echo` command and the `|` (pipe) operator.
