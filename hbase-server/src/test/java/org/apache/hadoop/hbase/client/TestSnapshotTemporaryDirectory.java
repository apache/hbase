...
public class TestSnapshotTemporaryDirectory {
  ...
  public static Iterable<Integer> data() {
    return Arrays.asList(SnapshotManifestV1.DESCRIPTOR_VERSION,
  ...
  public void setup() throws Exception {
    TableDescriptor htd = TableDescriptorBuilder.newBuilder(TABLE_NAME)
        .setRegionReplication(getNumReplicas()).build();
