...
|===
| | HBase-1.5.x | HBase-1.6.x
| Hadoop-2.7.7+ | icon:check-circle[role="green"] | icon:times-circle[role="red"]
| Hadoop-2.8.[0-4] | icon:times-circle[role="red"] | icon:times-circle[role="red"]
| Hadoop-2.8.5+ | icon:check-circle[role="green"] | icon:check-circle[role="green"]
| Hadoop-2.9.[0-1] | icon:times-circle[role="red"] | icon:times-circle[role="red"]
| Hadoop-2.9.2+ | icon:check-circle[role="green"] | icon:check-circle[role="green"]
| Hadoop-2.10.x | icon:exclamation-circle[role="yellow"] | icon:check-circle[role="green"]
|===
