...
image::../images/backup-intra-cluster.png[]
...
image::../images/backup-dedicated-cluster.png[]
...
image::../images/backup-cloud-appliance.png[]
...
image::../images/backup-app-components.png[]
