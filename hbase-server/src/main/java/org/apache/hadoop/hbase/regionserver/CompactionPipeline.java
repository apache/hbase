...
public class CompactionPipeline {
   ...
   *          pipeline is swapped as part of in-memory-flush and further merge/compaction. Don't
   *          update the region size when the swap is result of the snapshot (flush-to-disk).
