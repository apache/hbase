 ...
 * (see
 * {@link org.apache.hadoop.hbase.constraint.Constraints#remove(org.apache.hadoop.hbase.HTableDescriptor)},
 ...
 * {@link org.apache.hadoop.hbase.constraint.Constraints#disable(org.apache.hadoop.hbase.HTableDescriptor)},
 ...
 * {@link org.apache.hadoop.hbase.HTableDescriptor}. This is particularly important when adding a
 * constraint(s) to the {@link org.apache.hadoop.hbase.HTableDescriptor} as it first retrieves the
 * next priority from a custom value set in the descriptor, adds each constraint (with increasing
 * priority) to the descriptor, and then the next available priority is re-stored back in the
 ...
 * and
 * {@link org.apache.hadoop.hbase.constraint.Constraints#add(org.apache.hadoop.hbase.HTableDescriptor, Class, org.apache.hadoop.conf.Configuration)}.
 * Any changes on <i>a single HTableDescriptor</i> should be serialized, either within a single
 ...
 * modifications to the {@link org.apache.hadoop.hbase.HTableDescriptor} for a given table. As such,
 * the usual renabling of tables should be used for propagating changes to the table. When at all
 * possible, Constraints should be added to the table before the table is created.</li>
 ...
 * {@link org.apache.hadoop.hbase.HTableDescriptor} via the usual method.</li>
 * </ol>
 * <p>
 ...
 * {@link org.apache.hadoop.hbase.HTableDescriptor}. Thus, to change the
 ...
 * bloat in your {@link org.apache.hadoop.hbase.HTableDescriptor}, meaning you are keeping around a
 * ton of redundant information. Second, it is going to make examining your table in the shell, via
 * <code>describe 'table'</code>, a huge pain as you will have to dig through a ton of irrelevant
 * config values to find the ones you set. In short, just do it the right way.
 */
