...
public class TestOnlineMergeTool {
   ...
   */
  @Test(timeout = 500000)
  public void testMergeSizeBasedRegion() throws Exception {
    ...
    String[] args = new String[]{"--tableName=" + tableName, "--maxRegionSize=0"
        , "--targetRegionCount=2", "--printExecutionPlan=false"
        , "--configMergePauseTime=10000"};
    HBaseConfiguration hBaseConfiguration = new HBaseConfiguration(UTIL.getConfiguration());
    Class<?> aClass1 = Class.forName("org.apache.hadoop.hbase.util.OnlineMergeTool");
    Constructor<?> constructor = aClass1.getConstructor(HBaseConfiguration.class);
    OnlineMergeTool onlineMergeTool = (OnlineMergeTool) constructor.newInstance(hBaseConfiguration);
   ...
   */
  @Test(timeout = 500000)
  public void testMergeRangRegion() throws Exception {
   ...
   */
  @Test(timeout = 500000)
  public void testMergeTimeBasedRegion() throws Exception {
    ...
    long post = System.currentTimeMillis() + 30 * 1000;
    args[0] = "--tableName=" + tableName;
    args[1] = "--maxRegionSize=" + 0;
    args[2] = "--maxRegionCreateTime=" + post;
