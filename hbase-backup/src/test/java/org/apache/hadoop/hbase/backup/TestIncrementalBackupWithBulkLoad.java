...
public class TestIncrementalBackupWithBulkLoad extends TestBackupBase {
  ...
  public void TestIncBackupDeleteTable() throws Exception {
    ...
    int actual = TestBulkLoadHFiles.loadHFiles(testName, table1Desc, TEST_UTIL, famName, qualName,
      false, null,
    ...
    // #4 bulk load again
    LOG.debug("bulk loading into " + testName);
    int actual1 = TestBulkLoadHFiles.loadHFiles(testName, table1Desc, TEST_UTIL, famName, qualName,
      false, null,
