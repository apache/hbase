...
public class TestSecureRESTServer {
  ...
  private static void setSecuredHadoopConfiguration(Configuration conf,
      String servicePrincipal, String serviceKeytab, String spnegoServerPrincipal) {
    ...
    // HDFS
    conf.set(DFSConfigKeys.DFS_NAMENODE_USER_NAME_KEY, servicePrincipal);
    conf.set(DFSConfigKeys.DFS_NAMENODE_KEYTAB_FILE_KEY, serviceKeytab);
    conf.set(DFSConfigKeys.DFS_DATANODE_USER_NAME_KEY, servicePrincipal);
    conf.set(DFSConfigKeys.DFS_DATANODE_KEYTAB_FILE_KEY, serviceKeytab);
  ...
  public static void setupServer() throws Exception {
    ...
    // Work around HBASE-20950 missing in branch-2.0 and branch-2.1
    HBaseKerberosUtils.setPrincipalForTesting(SERVICE_PRINCIPAL+ "@" + KDC.getRealm());
    HBaseKerberosUtils.setSecuredConfiguration(conf);
    setSecuredHadoopConfiguration(conf,
        SERVICE_PRINCIPAL+ "@" + KDC.getRealm(), serviceKeytab.getAbsolutePath(),
