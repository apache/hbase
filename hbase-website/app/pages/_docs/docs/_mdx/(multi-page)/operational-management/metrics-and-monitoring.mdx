...
![master-snapshot](../../images/master-snapshot.png)

**_Snapshot Storefile Stats Example 1_**
![1 snapshot](../../images/1-snapshot.png)

**_Snapshot Storefile Stats Example 2_**
![2 snapshot](../../images/2-snapshots.png)

**_Empty Snapshot Storfile Stats Example_**
![empty snapshots](../../images/empty-snapshots.png)
