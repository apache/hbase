 ...
 * {@link org.apache.hadoop.hbase.ClusterStatus}. That class is a data structure that holds snapshot
 * of current view on cluster. This class is about tracking cluster attributes up in zookeeper.
 */
