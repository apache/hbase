...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.14.1)",
    date = "2021-07-19")
public class TDelete implements org.apache.thrift.TBase<TDelete, TDelete._Fields>,
    java.io.Serializable, Cloneable, Comparable<TDelete> {
  ...
  public TDelete
      setColumns(@org.apache.thrift.annotation.Nullable java.util.List<TColumn> columns) {
  ...
  private static class TDeleteStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<TDelete> {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter60 : struct.attributes
                .entrySet()) {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter62 : struct.attributes
              .entrySet()) {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.attributes =
              new java.util.HashMap<java.nio.ByteBuffer, java.nio.ByteBuffer>(2 * _map66.size);
          @org.apache.thrift.annotation.Nullable
