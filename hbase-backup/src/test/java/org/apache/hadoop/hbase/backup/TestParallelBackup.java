...
public class TestParallelBackup extends TestBackupBase {
  ...
  @Test public void testParallelFullBackupOnDifferentTable() throws Exception {
    int before;
  ...
  @Test public void testParallelFullBackupOnSameTable() throws Exception {
    int before;
  ...
  @Test public void testParallelFullBackupOnMultipleTable() throws Exception {
    int before;
