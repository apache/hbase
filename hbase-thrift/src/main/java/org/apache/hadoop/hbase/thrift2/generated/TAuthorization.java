...
public class TAuthorization
    implements org.apache.thrift.TBase<TAuthorization, TAuthorization._Fields>,
    java.io.Serializable, Cloneable, Comparable<TAuthorization> {
  ...
  public TAuthorization(TAuthorization other) {
    if (other.isSetLabels()) {
      java.util.List<java.lang.String> __this__labels =
          new java.util.ArrayList<java.lang.String>(other.labels);
  ...
  public TAuthorization
      setLabels(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> labels) {
    this.labels = labels;
    return this;
  }
  ...
  private static class TAuthorizationStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<TAuthorization> {
  ...
  private static class TAuthorizationTupleScheme
      extends org.apache.thrift.scheme.TupleScheme<TAuthorization> {
