...
public class MetricsRegionServerSourceImpl extends BaseSourceImpl
  ...
  public void getMetrics(MetricsCollector metricsCollector, boolean all) {
    ...
    if (rsWrap != null) {
      addGaugesToMetricsRecordBuilder(mrb)
          ...
          .addCounter(
            Interns.info(BLOCK_CACHE_PRIMARY_HIT_COUNT, BLOCK_CACHE_PRIMARY_HIT_COUNT_DESC),
  ...
  private MetricsRecordBuilder addGaugesToMetricsRecordBuilder(MetricsRecordBuilder mrb) {
    return mrb.addGauge(Interns.info(REGION_COUNT, REGION_COUNT_DESC), rsWrap.getNumOnlineRegions())
        ...
        .addGauge(
          Interns.info(PERCENT_FILES_LOCAL_SECONDARY_REGIONS,
        ...
        .addGauge(
          Interns.info(BLOCK_CACHE_EXPRESS_HIT_PERCENT, BLOCK_CACHE_EXPRESS_HIT_PERCENT_DESC),
        ...
        .addGauge(
          Interns.info(BYTE_BUFF_ALLOCATOR_USED_BUFFER_COUNT,
