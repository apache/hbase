---
title: "Known Incompatibilities Among HBase Versions"
description: "Comprehensive list of breaking changes and incompatibilities between HBase versions, particularly for HBase 2.0."
---
