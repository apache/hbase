...
/*
 * <p> Copied from <a href="https://issues.apache.org/jira/browse/HADOOP-3315">hadoop-3315
 * tfile</a>. Remove after tfile is committed and use the tfile version of this class instead.</p>
 */
class KeySampler {
  Random random;
  int min, max;
  ...
  private int keyPrefixToInt(byte[] key) {
    byte[] b = key;
    int o = 0;
    return (b[o] & 0xff) << 24 | (b[o + 1] & 0xff) << 16 | (b[o + 2] & 0xff) << 8
        | (b[o + 3] & 0xff);
  }
