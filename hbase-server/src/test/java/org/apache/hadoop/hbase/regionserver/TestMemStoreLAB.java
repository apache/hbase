...
public class TestMemStoreLAB {
  ...
  public void testLABChunkQueue() throws Exception {
    ...
    mslab = new MemStoreLAB(conf, MemStoreChunkPool.getPool(conf));
  ...
  private Thread getChunkQueueTestThread(final MemStoreLAB mslab, String threadName) {
    Thread thread = new Thread() {
      ...
      public void run() {
        while (!stopped) {
          ...
          mslab.allocateBytes(MemStoreLAB.MAX_ALLOC_DEFAULT - 1);
        }
      }
