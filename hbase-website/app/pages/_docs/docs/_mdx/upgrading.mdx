---
title: "upgrading"
description: "Documentation for upgrading"
---
# 
...
<table>
<caption>Compatibility Matrix <a href="#fn1" class="footnote-ref" id="fnref1" role="doc-noteref"><sup>1</sup></a></caption>
<colgroup>
<col style={{width: "25%"}} />
<col style={{width: "25%"}} />
<col style={{width: "25%"}} />
...
<td style={{textAlign: "left"}}><p>Major</p></td>
<td style={{textAlign: "left"}}><p>Minor</p></td>
<td style={{textAlign: "left"}}><p>Patch</p></td>
</tr>
<tr>
<td style={{textAlign: "left"}}><p>Client-Server wire Compatibility</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
</tr>
<tr>
<td style={{textAlign: "left"}}><p>Server-Server Compatibility</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
</tr>
<tr>
<td style={{textAlign: "left"}}><p>File Format Compatibility</p></td>
<td style={{textAlign: "left"}}><p>N <a href="#fn2" class="footnote-ref" id="fnref2" role="doc-noteref"><sup>2</sup></a></p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
</tr>
<tr>
<td style={{textAlign: "left"}}><p>Client API Compatibility</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
</tr>
<tr>
<td style={{textAlign: "left"}}><p>Client Binary Compatibility</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
</tr>
<tr>
<td colspan="4" style={{textAlign: "left"}}><p>Server-Side Limited API Compatibility</p></td>
</tr>
<tr>
<td style={{textAlign: "right"}}><p>Stable</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
</tr>
<tr>
<td style={{textAlign: "right"}}><p>Evolving</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
</tr>
<tr>
<td style={{textAlign: "right"}}><p>Unstable</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
</tr>
<tr>
<td style={{textAlign: "left"}}><p>Dependency Compatibility</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
</tr>
<tr>
<td style={{textAlign: "left"}}><p>Operational Compatibility</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>N</p></td>
<td style={{textAlign: "left"}}><p>Y</p></td>
</tr>
...
<hr />
<ol>
<li id="fn1"><p>Note that this indicates what could break, not that it will break. We will/should add specifics in our release notes.<a href="#fnref1" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
<li id="fn2"><p>comp_matrix_offline_upgrade_note,Running an offline upgrade tool without downgrade might be needed. We will typically only support migrating data from major version X to major version X+1.<a href="#fnref2" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
</ol>
</section>

<Callout type="warn">
HBase 1.7.0 release violated client-server wire compatibility guarantees and was subsequently withdrawn after the incompatibilities were reported and fixed in 1.7.1. If you are considering an upgrade to 1.7.x line, see [Upgrading to 1.7.1+](#upgrade1.7.x).
</Callout>
...
A rolling upgrade is the process by which you update the servers in your cluster a server at a time. You can rolling upgrade across HBase versions if they are binary or wire compatible. See [hbase.rolling.restart](#hbase.rolling.restart) for more on what this means. Coarsely, a rolling upgrade is a graceful stop each server, update the software, and then restart. You do this for each server in the cluster. Usually you upgrade the Master first and then the RegionServers. See [???](#rolling) for tools that can help use the rolling upgrade process.
...
Unless otherwise specified, HBase minor versions are binary compatible. You can do a [Rolling Upgrades](#hbase.rolling.upgrade) between HBase point versions. For example, you can go to 1.4.4 from 1.4.6 by doing a rolling upgrade across the cluster replacing the 1.4.4 binary with a 1.4.6 binary.
...
The RegionServer Grouping feature has been reimplemented. See section [???](#migrating.rsgroup) in [???](#ops_mgt) for more details.

The `hbase:namespace` table has been removed and fold into `hbase:meta`. See section [???](#namespace_table) in [???](#datamodel) for more details.
...
- Metrics related to the Distributed Log Replay feature are no longer present. They were previously found in the region server context under the name 'replay'. See the section [upgrade2.0.distributed.log.replay](#upgrade2.0.distributed.log.replay) for details.
...
After the Apache HTrace project moved to the Attic/retired, the traces in HBase are left broken and unmaintained since HBase 2.0. A new project [HBASE-22120](https://issues.apache.org/jira/browse/HBASE-22120) will replace HTrace with OpenTelemetry. It will be shipped in 3.0.0 release. Please see the reference guide section [???](#tracing) for more details.
...
[^1]: See 'Source Compatibility' [https://blogs.oracle.com/darcy/entry/kinds_of_compatibility](https://blogs.oracle.com/darcy/entry/kinds_of_compatibility)
