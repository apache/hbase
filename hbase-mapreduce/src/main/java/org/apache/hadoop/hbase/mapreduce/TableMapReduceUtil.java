...
public class TableMapReduceUtil {
  ...
  public static void initTableSnapshotMapperJob(String snapshotName, Scan scan,
      Class<? extends TableMapper> mapper, Class<?> outputKeyClass, Class<?> outputValueClass,
      Job job, boolean addDependencyJars, Path tmpRestoreDir,
   ...
   *          that is designated in <code>hbase-site.xml</code>. Set this String to the zookeeper
   *          ensemble of an alternate remote cluster when you would have the reduce write a cluster
   *          that is other than the default; e.g. copying tables between clusters, the source would
   *          be designated by <code>hbase-site.xml</code> and this param would have the ensemble
