...
${propertiesXml}
  ...
  <property>
    ...
    it("should ignore property blocks inside XML comments", () => {
      const xml = createXml(`  <!--
  <property>
    <name>hbase.zookeeper.property.initLimit</name>
    <value>10</value>
    <description>Example block that should be ignored</description>
  </property>
  -->
  <property>
    <name>hbase.zookeeper.property.initLimit</name>
    <value>5</value>
    <description>Real property block</description>
  </property>`);
      ...
      expect(properties[0]).toEqual({
        ...
        value: "5",
        description: "Real property block"
      });
    });
  });
