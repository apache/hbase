...
public final class Filter {
  ...
  public static Filter parse(String filterString, boolean ignoreCase) {
    return parse(filterString, Arrays.asList(Field.values()), ignoreCase);
  }

  public static Filter parse(String filterString, List<Field> fields, boolean ignoreCase) {
    int index = 0;
    ...
    return new Filter(ignoreCase, not, field, operator, fieldValue);
  }
  ...
  private Filter(boolean ignoreCase, boolean not, Field field, Operator operator,
    FieldValue value) {
  ...
  public static final class FilterBuilder {
    ...
    public Filter equal(FieldValue value) {
    ...
    public Filter notEqual(FieldValue value) {
    ...
    public Filter doubleEquals(FieldValue value) {
      return newFilter(false, Operator.DOUBLE_EQUALS, value);
    }

    public Filter doubleEquals(Object value) {
      return doubleEquals(field.newValue(value));
    }

    public Filter notDoubleEquals(FieldValue value) {
      return newFilter(true, Operator.DOUBLE_EQUALS, value);
    }

    public Filter notDoubleEquals(Object value) {
      return notDoubleEquals(field.newValue(value));
    }

    public Filter greater(FieldValue value) {
    ...
    public Filter notGreater(FieldValue value) {
      return newFilter(true, Operator.GREATER, value);
    }

    public Filter notGreater(Object value) {
      return notGreater(field.newValue(value));
    }

    public Filter greaterOrEqual(FieldValue value) {
    ...
    public Filter notGreaterOrEqual(FieldValue value) {
      return newFilter(true, Operator.GREATER_OR_EQUAL, value);
    }

    public Filter notGreaterOrEqual(Object value) {
      return notGreaterOrEqual(field.newValue(value));
    }

    public Filter less(FieldValue value) {
    ...
    public Filter notLess(FieldValue value) {
      return newFilter(true, Operator.LESS, value);
    }

    public Filter notLess(Object value) {
      return notLess(field.newValue(value));
    }

    public Filter lessOrEqual(FieldValue value) {
    ...
    public Filter notLessOrEqual(FieldValue value) {
      return newFilter(true, Operator.LESS_OR_EQUAL, value);
    }

    public Filter notLessOrEqual(Object value) {
      return notLessOrEqual(field.newValue(value));
    }

    private Filter newFilter(boolean not, Operator operator, FieldValue value) {
      return new Filter(ignoreCase, not, field, operator, value);
    }
  }
}
