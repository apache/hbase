...
public class OAuthBearerSaslClient implements SaslClient {
    ...
    try {
      ...
      switch (state) {
        case SEND_CLIENT_FIRST_MESSAGE:
          ...
          return new OAuthBearerClientInitialResponse(callback.token().value(), extensions)
            .toBytes();
  ...
  private SaslExtensions retrieveCustomExtensions() throws SaslException {
    ...
    try {
      ...
      LOG.debug("Extensions callback is not supported by client callback handler {}, "
          + "no extensions will be added", callbackHandler());
    } catch (Exception e) {
