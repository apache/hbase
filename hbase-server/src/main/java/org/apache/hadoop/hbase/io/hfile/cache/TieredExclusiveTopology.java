 ...
 *
 * <p>In an exclusive topology, a block should normally reside in only one tier at a time.
 * Promotion from L2 to L1 is therefore modeled as a move: insert into L1 and evict from L2.</p>
 *
