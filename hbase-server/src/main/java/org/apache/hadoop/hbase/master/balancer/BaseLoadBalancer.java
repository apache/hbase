...
public abstract class BaseLoadBalancer implements LoadBalancer {
  ...
  */
  ...
  @Override
  public abstract List<RegionPlan> tableBalancePlans(TableName tableName,
      Map<ServerName, List<RegionInfo>> loadOfOneTable);

  @Override
  public List<RegionPlan> clusterBalancePlans(Map<TableName, Map<ServerName,
    ...
    if (isByTable) {
      ...
      loadOfAllTable.forEach((tableName, loadOfOneTable) -> {
        ...
        List<RegionPlan> partialPlans = tableBalancePlans(tableName, loadOfOneTable);
      ...
      return tableBalancePlans(HConstants.ENSEMBLE_TABLE_NAME, toEnsumbleTableLoad(loadOfAllTable));
    }
  }
