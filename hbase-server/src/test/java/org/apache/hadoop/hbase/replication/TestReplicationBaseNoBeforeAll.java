...
public class TestReplicationBaseNoBeforeAll {
  private static final Logger LOG = LoggerFactory.getLogger(TestReplicationBaseNoBeforeAll.class);
  ...
  protected static void configureClusters(HBaseTestingUtility util1, HBaseTestingUtility util2) {
    setupConfig(util1, "/1");
    setupConfig(util2, "/2");
