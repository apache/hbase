...
HBase has the same version requirements as it does for runtime. See [Java](/docs/configuration/basic-prerequisites#java) for a complete
...
With Eclipse set up as explained above in [Eclipse](/docs/developer#eclipse), you can also use the **Build** command in Eclipse.
...
See the [Running tests](/docs/building-and-developing/tests#running-tests) section in [Unit Tests](/docs/building-and-developing/tests#unit-tests)
...
[Building against various Hadoop versions](/docs/building-and-developing/building#building-against-various-hadoop-versions). See [Java](/docs/configuration/basic-prerequisites#java) for a complete
support matrix of Java version by HBase version.
