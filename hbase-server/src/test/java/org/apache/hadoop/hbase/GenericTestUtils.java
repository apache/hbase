...
public abstract class GenericTestUtils {
  ...
  /**
   * List all of the files in 'dir' that match the regex 'pattern'. Then check that this list is
   * identical to 'expectedMatches'.
   * @throws IOException if the dir is inaccessible
   */
  public static void assertGlobEquals(File dir, String pattern, String... expectedMatches)
    throws IOException {
  ...
  /**
   * An Answer implementation that simply forwards all calls through to a delegate. This is useful
   * as the default Answer for a mock object, to create something like a spy on an RPC proxy. For
   * example: <code>
