...
description: "TableSnapshotScanner and TableSnapshotInputFormat for scanning HBase snapshots directly from HDFS."
---
...
### [HDFS ACLs](https://hadoop.apache.org/docs/r2.7.1/hadoop-project-dist/hadoop-hdfs/HdfsPermissionsGuide.html#ACLs_Access_Control_Lists)
