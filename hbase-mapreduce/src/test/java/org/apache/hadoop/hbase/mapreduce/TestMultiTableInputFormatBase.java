  ...
  public static class MRSplitsConnection implements Connection {
    ...
    public RegionLocator getRegionLocator(final TableName tableName) throws IOException {
      ...
      final byte[][] endKeys = new byte[][] { Bytes.toBytes("aaaa"), Bytes.toBytes("bbb"),
          ...
          Bytes.toBytes("ggg"), Bytes.toBytes("hhh"), Bytes.toBytes("iii"), Bytes.toBytes("lll"),
          Bytes.toBytes("mmm"), Bytes.toBytes("nnn"), Bytes.toBytes("ooo"), Bytes.toBytes("ppp"),
          Bytes.toBytes("qqq"), Bytes.toBytes("rrr"), Bytes.toBytes("sss"), Bytes.toBytes("ttt"),
          Bytes.toBytes("uuu"), Bytes.toBytes("vvv"), Bytes.toBytes("zzz"),
