...
public class TestAncestryInvalidation extends TestBackupBase {

  @ClassRule
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestAncestryInvalidation.class);

  public TestAncestryInvalidation(Boolean b) {
  }
  ...
  @Test
  public void TestItInvalidatesAncestry() throws IOException {
    ...
    try (Connection conn = ConnectionFactory.createConnection(conf1);
      ...
      // should throw error
      final BackupRequest failOnInvalidAncestryReq =
        new BackupRequest.Builder().withBackupType(BackupType.INCREMENTAL).withTableList(tables)
          ...
          .withFailOnInvalidAncestry(true).build();
      assertThrows(InvalidAncestryException.class,
        () -> BackupClientFactory.create(conn, "backupId", failOnInvalidAncestryReq));
      ...
      // Check that the new ancestry line is valid
      assertEquals(
        BackupClientFactory.create(conn, "backupId", failOnInvalidAncestryReq).getClass(),
