...
public class TestRefreshMetaProcedure {
  ...
  public void testScanBackingStorage() throws Exception {
    ...
    Method method =
      RefreshMetaProcedure.class.getDeclaredMethod("scanBackingStorage", Connection.class);
    method.setAccessible(true);

    List<RegionInfo> fsRegions =
      (List<RegionInfo>) method.invoke(procedure, TEST_UTIL.getConnection());
  ...
  public void testHasBoundaryChanged() throws Exception {
    ...
    Method method = RefreshMetaProcedure.class.getDeclaredMethod("hasBoundaryChanged",
