...
const EXCLUDED_HTML_PATHS = new Set(["404/index.html", "__spa-fallback.html"]);
...
export function shouldIncludeInSitemap(relativePath: string, html: string): boolean {
...
export async function main() {
  ...
  console.log(
    `Generated sitemap with ${entries.length} URLs at ${PUBLIC_SITEMAP_PATH} and ${BUILD_SITEMAP_PATH}`
  );
}
