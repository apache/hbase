...
public class TestSnapshotRegionProcedure {
  ...
  public void setup() throws Exception {
    ...
    TABLE_NAME = TableName.valueOf(Bytes.toBytes("SRPTestTable"));
    CF = Bytes.toBytes("cf");
    SNAPSHOT_NAME = "SnapshotRegionProcedureTest";
  ...
  public void testSimpleSnapshotRegion() throws Exception {
    ...
    List<Pair<RegionInfo, ServerName>> regions =
      master.getAssignmentManager().getTableRegionsAndLocations(TABLE_NAME, true);
