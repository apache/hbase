 ...
 *
 * When drilling down, going to next {@link Mode} with initial {@link Filter}s.
 */
...
public class DrillDownInfo {
  ...
  public DrillDownInfo(Mode nextMode, List<Filter> initialFilters) {
  ...
  public List<Filter> getInitialFilters() {
