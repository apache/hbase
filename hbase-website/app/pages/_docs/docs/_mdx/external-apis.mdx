...
<Callout type="info">
  ...
  API](/docs/external-apis#stateful-endpoints-for-scan-operations) can also be used for large results.
</Callout>
...
- `cacheblocks` - Whether to use the [Block Cache](/docs/performance#block-cache) in the RegionServer. By default `true`.
