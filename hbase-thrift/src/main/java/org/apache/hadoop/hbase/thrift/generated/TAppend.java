...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.14.1)",
    date = "2021-07-19")
public class TAppend implements org.apache.thrift.TBase<TAppend, TAppend._Fields>,
    java.io.Serializable, Cloneable, Comparable<TAppend> {
  ...
  public TAppend(java.nio.ByteBuffer table, java.nio.ByteBuffer row,
      java.util.List<java.nio.ByteBuffer> columns, java.util.List<java.nio.ByteBuffer> values) {
    this();
  ...
  public TAppend(TAppend other) {
    ...
    if (other.isSetColumns()) {
      java.util.List<java.nio.ByteBuffer> __this__columns =
          new java.util.ArrayList<java.nio.ByteBuffer>(other.columns.size());
    ...
    if (other.isSetValues()) {
      java.util.List<java.nio.ByteBuffer> __this__values =
          new java.util.ArrayList<java.nio.ByteBuffer>(other.values.size());
  ...
  public TAppend setColumns(
      @org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> columns) {
    this.columns = columns;
    return this;
  }
  ...
  public TAppend
      setValues(@org.apache.thrift.annotation.Nullable java.util.List<java.nio.ByteBuffer> values) {
    this.values = values;
    return this;
  }
  ...
  private static class TAppendStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<TAppend> {
