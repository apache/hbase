---
title: "Unit Testing HBase Applications"
description: "This chapter discusses unit testing your HBase application using JUnit, Mockito, MRUnit, and HBaseTestingUtility."
---
