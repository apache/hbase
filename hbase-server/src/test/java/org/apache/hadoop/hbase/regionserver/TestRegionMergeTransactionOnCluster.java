...
public class TestRegionMergeTransactionOnCluster {
  ...
  public void testCleanMergeReference() throws Exception {
    ...
    try {
      ...
      Result mergedRegionResult = MetaTableAccessor.getRegionResult(MASTER.getConnection(),
  ...
  public void testMergeWithReplicas() throws Exception {
    ...
    try {
      ...
      assertTrue(initialRegions
          .contains(RegionReplicaUtil.getRegionInfoForReplica(mergedRegions.getSecond(), 1))); // this
                                                                                               // is
                                                                                               // the
                                                                                               // replica
                                                                                               // of
      ...
      assertTrue(!initialRegions
          .contains(RegionReplicaUtil.getRegionInfoForReplica(currentRegions.get(0), 1))); // replica
                                                                                           // of the
                                                                                           // new
                                                                                           // region
      assertTrue(currentRegions
          .contains(RegionReplicaUtil.getRegionInfoForReplica(currentRegions.get(0), 1))); // replica
                                                                                           ...
                                                                                           // region
      assertTrue(!currentRegions
          .contains(RegionReplicaUtil.getRegionInfoForReplica(mergedRegions.getFirst(), 1))); // replica
                                                                                              // of
                                                                                              // the
                                                                                              // merged
                                                                                              // region
      assertTrue(!currentRegions
          .contains(RegionReplicaUtil.getRegionInfoForReplica(mergedRegions.getSecond(), 1))); // replica
                                                                                               // of
                                                                                               // the
                                                                                               // merged
                                                                                               // region
  ...
  static class MyMasterRpcServices extends MasterRpcServices {
    ...
    public ReportRegionStateTransitionResponse reportRegionStateTransition(RpcController c,
      ...
      if (enabled.get() && req.getTransition(0).getTransitionCode() == TransitionCode.READY_TO_MERGE
