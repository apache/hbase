...
public class HStore implements Store {
  ...
  public List<StoreFile> compact(CompactionContext compaction) throws IOException {
    return compact(compaction, null);
  }

  @Override
  public List<StoreFile> compact(CompactionContext compaction, User user) throws IOException {
    ...
    try {
      ...
      List<Path> newFiles = compaction.compact(user);
