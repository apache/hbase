...
public class CoprocessorWhitelistMasterObserver implements MasterCoprocessor, MasterObserver {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(CoprocessorWhitelistMasterObserver.class);
  ...
  @Override
  public void preCreateTable(ObserverContext<MasterCoprocessorEnvironment> ctx, TableDescriptor htd,
   ...
   * @param wlPath can be: 1) a "*" to wildcard all coprocessor paths 2) a specific filesystem (e.g.
   *          hdfs://my-cluster/) 3) a wildcard path to be evaluated by
   *          {@link FilenameUtils#wildcardMatch(String, String)} path can specify scheme or not
   *          (e.g. "file:///usr/hbase/coprocessors" or for all filesystems
