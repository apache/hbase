...
public final class X509Util {
  ...
  /**
   * Set the SSL wrapSize for netty. This is only a maximum wrap size. Buffers smaller
   * than this will not be consolidated, but buffers larger than this will be split into
   * multiple wrap buffers. The netty default of 16k is not great for hbase which tends to
   * return larger payloads than that, meaning most responses end up getting chunked up.
