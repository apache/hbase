...
public class TestCleanBucketCache {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(TestCleanBucketCache.class);
  ...
  @Test
  public void testCleanBucketCache() throws Exception {
    ...
    long blocksCount = regionServingRS.getBlockCache().get().getBlockCaches()[1].getBlockCount();
    assertNotEquals(0, blocksCount);

    HRegion r = regionServingRS.getRegions().get(0);
