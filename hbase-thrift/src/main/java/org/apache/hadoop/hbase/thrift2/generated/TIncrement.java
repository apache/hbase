...
public class TIncrement implements org.apache.thrift.TBase<TIncrement, TIncrement._Fields>,
  ...
  public TIncrement(java.nio.ByteBuffer row, java.util.List<TColumnIncrement> columns) {
    this();
  ...
  public TIncrement(TIncrement other) {
    ...
    if (other.isSetColumns()) {
      java.util.List<TColumnIncrement> __this__columns =
          new java.util.ArrayList<TColumnIncrement>(other.columns.size());
  ...
  public TIncrement
      setColumns(@org.apache.thrift.annotation.Nullable java.util.List<TColumnIncrement> columns) {
    this.columns = columns;
    return this;
  }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter78 : struct.attributes
                .entrySet()) {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter80 : struct.attributes
              .entrySet()) {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.attributes =
              new java.util.HashMap<java.nio.ByteBuffer, java.nio.ByteBuffer>(2 * _map84.size);
          @org.apache.thrift.annotation.Nullable
