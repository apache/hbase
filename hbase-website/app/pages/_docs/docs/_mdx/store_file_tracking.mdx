...
description: "An abstraction layer to track store files with pluggable implementations for different file systems."
---
...
<Callout>
When the store file tracking implementation is specified in **hbase_site.xml**, this configuration is also propagated into a tables configuration
