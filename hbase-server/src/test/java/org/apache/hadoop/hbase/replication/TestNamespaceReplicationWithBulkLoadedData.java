...
public final class TestNamespaceReplicationWithBulkLoadedData extends TestBulkLoadReplication {
  ...
  public static void setUpBeforeAll() throws Exception {
    ...
    /**
     * Parent class already sets peer1 from 1 <-> 2 <-> 3 and this test add the fourth cluster. So
     * we have following topology: 1 / \ 2 4 / 3 The 1 -> 4 has two peers, ns_peer1: ns1 -> ns1
     * (validate this peer hfile-refs) ns_peer1 configuration is NAMESPACES => ["ns1"] ns_peer2:
     * ns2:t2_syncup -> ns2:t2_syncup, this peers is ns_peer2 configuration is NAMESPACES =>
