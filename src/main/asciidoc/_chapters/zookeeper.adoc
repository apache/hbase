...
Since HBase version 2.4.18 ZooKeeper client TLS settings are also available in _hbase-site.xml_ via
`hbase.zookeeper.property` prefix. In contrast to Java system properties this could be more convenient
