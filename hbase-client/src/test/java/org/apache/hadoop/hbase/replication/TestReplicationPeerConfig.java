...
public class TestReplicationPeerConfig {
  ...
  public void testNeedToReplicateWithoutReplicatingAll() {
    ...
    peerConfig = new ReplicationPeerConfig.ReplicationPeerConfigBuilderImpl()
        .setReplicateAllUserTables(false).setNamespaces(Sets.newHashSet(NAMESPACE_REPLICATE))
        .build();
    assertTrue(peerConfig.needToReplicate(TABLE_A));
    ...
    peerConfig = new ReplicationPeerConfig.ReplicationPeerConfigBuilderImpl()
        ...
        .setNamespaces(Sets.newHashSet(NAMESPACE_REPLICATE)).build();
    assertTrue(peerConfig.needToReplicate(TABLE_A));
    ...
    peerConfig = new ReplicationPeerConfig.ReplicationPeerConfigBuilderImpl()
        .setReplicateAllUserTables(false).setTableCFsMap(tableCfs)
        .setNamespaces(Sets.newHashSet(NAMESPACE_OTHER)).build();
    assertTrue(peerConfig.needToReplicate(TABLE_A));
