...
/**
 * Compaction server throughput bound
 */
@InterfaceAudience.Public
public class CompactionThroughputBound {
  long maxThroughputUpperBound;
  long maxThroughputLowerBound;
  long maxThroughputOffPeak;

  public CompactionThroughputBound() {
  }

  public CompactionThroughputBound(
    HBaseProtos.CompactionThroughputBound compactionThroughputBound) {
    this.maxThroughputLowerBound = compactionThroughputBound.getMaxThroughputLowerBound();
    this.maxThroughputUpperBound = compactionThroughputBound.getMaxThroughputUpperBound();
    this.maxThroughputOffPeak = compactionThroughputBound.getMaxThroughputOffPeak();
  }
