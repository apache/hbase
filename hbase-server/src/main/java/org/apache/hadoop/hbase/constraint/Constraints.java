 ...
 * <p>
 * NOTE: this class is NOT thread safe. Concurrent setting/enabling/disabling of constraints can
 * cause constraints to be run at incorrect times or not at all.
 */
...
public final class Constraints {
   ...
   * @throws IOException If the {@link ConstraintProcessor} CP couldn't be added to the table.
   */
   ...
   * added.
   * @param desc {@link HTableDescriptor} where to disable {@link Constraint Constraints}.
   */
   ...
   *         {@code NULL} otherwise.
   */
  private static Pair<String, String> getKeyValueForClass(HTableDescriptor desc,
   ...
   * @param desc {@link HTableDescriptor} to add {@link Constraint Constraints}
   ...
   * regionserver before those added to the {@link HTableDescriptor} later.
   * @param desc table descriptor to the constraint to
   ...
   */
  private static void addConstraint(HTableDescriptor desc, Class<? extends Constraint> clazz,
      Configuration conf, long priority) throws IOException {
   ...
   * @param clazz Constraint class to convert to a {@link HTableDescriptor} key
   ...
   */
  private static void writeConstraint(HTableDescriptor desc, String key, Configuration conf)
      throws IOException {
   ...
   * constraint is run.
   * @param desc {@link HTableDescriptor} to update
   ...
   * @param desc {@link HTableDescriptor} to modify
