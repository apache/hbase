...
public class AssignmentManager {
  ...
  public void processRegionsOnUnknownServers() {
    if (
      ...
      LOG.info(
        "Not attempting to assign any regions on UNKNOWN RegionServers because of configuration.");
      return;
    }
    LOG.info(
      "Reading meta to schedule process any UNKNOWN RegionServers without pending ServerCrashProcedure.");
