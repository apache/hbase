...
## Overview [#store-file-tracking-overview]
...
<Callout type="info">
  When the store file tracking implementation is specified in **hbase_site.xml**, this configuration
...
### DEFAULT [#store-file-tracking-default]
...
## Usage [#store-file-tracking-usage]
