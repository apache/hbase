...
* https://gitbox.apache.org/repos/asf?p=hbase-operator-tools.git[hbase-operator-tools] - operability and supportability tools, such as [HBCK2](#HBCK2)
...
<Callout type="info">
The _hbase_ script assumes all integration tests with exposed _main_ methods to be run
...
Replication may be disrupted and data loss may occur if you delete the replication tree (_/hbase/replication/_) from ZooKeeper.
Follow progress on this issue at [HBASE-10295](https://issues.apache.org/jira/browse/HBASE-10295).
</Callout>
