...
public class RegionServerReadOnlyController
  implements RegionServerObserver, RegionServerCoprocessor, ConfigurationObserver {

  private static final Logger LOG = LoggerFactory.getLogger(RegionServerReadOnlyController.class);
