...
- Provide input for discussion threads on the [mailing lists](/mailing-lists) (which usually have
  `[DISCUSS]` in the subject line).
- Answer questions on the user or developer mailing lists and on
  Slack.
- Make sure the HBase community is a welcoming one and that we adhere to our
  [Code of conduct](/code-of-conduct). Alert the PMC if you
  have concerns.
...
- Give talks and write blogs about HBase. Add these to the [News](/news) section
  of the website.
