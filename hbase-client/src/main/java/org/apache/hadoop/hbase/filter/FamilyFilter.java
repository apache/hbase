...
/**
 * <p>
 * This filter is used to filter based on the column family. It takes an operator (equal, greater,
 * not equal, etc) and a byte [] comparator for the column family portion of a key.
 * </p>
 * <p>
 ...
 * {@link org.apache.hadoop.hbase.client.Get#addFamily(byte[])} directly rather than a filter.
 */
...
public class FamilyFilter extends CompareFilter {
   ...
   *             {@link #FamilyFilter(CompareOperator, ByteArrayComparable)}
   */
  @Deprecated
