...
public class TopScreenModel {
  ...
  public void switchMode(Mode nextMode, List<Filter> initialFilters,
    ...
    fields = Collections.unmodifiableList(new ArrayList<>(currentMode.getFieldInfos().stream()
  ...
  public boolean addFilter(String filterString, boolean ignoreCase) {
    Filter filter = Filter.parse(filterString, fields, ignoreCase);
    if (filter == null) {
      return false;
    }
