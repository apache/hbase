...
description: "Using off-heap memory for HBase read and write paths to reduce GC pressure and improve P99/P999 RPC latencies."
---

## Overview [#offheap-read-write-overview]
...
![Offheap Overview](/docs-images/offheap-overview.png)
...
![ByteBuff Allocator Stats](/docs-images/bytebuff-allocator-stats.png)
