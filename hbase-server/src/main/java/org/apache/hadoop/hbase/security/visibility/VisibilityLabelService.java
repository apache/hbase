...
public interface VisibilityLabelService extends Configurable {
   ...
   * @param labels Labels to add to the system.
   ...
   * @param user The authorizing user
   * @param authLabels Labels which are getting authorized for the user
   ...
   * @param user The user whose authorization to be removed
   * @param authLabels Labels which are getting removed from authorization set
   ...
   * @param user Name of the user whose authorization to be retrieved
   ...
   * @param groups Name of the groups whose authorization to be retrieved
   * @param systemCall Whether a system or user originated call.
  ...
  /**
   * Creates tags corresponding to given visibility expression. <br>
   ...
   * @param withSerializationFormat specifies whether a tag, denoting the serialization version of
   *          the tags, to be added in the list. When this is true make sure to add the
   ...
   * Note: This will be concurrently called from multiple threads and implementation should take
   * care of thread safety.
   * @param authorizations Authorizations for the read request
   ...
   * @param user User for whom system auth check to be done.
   ...
   * Note: This will be concurrently called from multiple threads and implementation should take
   * care of thread safety.
   * @param putVisTags The visibility tags present in the Put mutation
   * @param putVisTagFormat The serialization format for the Put visibility tags. A
   *          <code>null</code> value for this format means the tags are written with unsorted label
   *          ordinals
   * @param deleteVisTags - The visibility tags in the delete mutation (the specified Cell
   *          Visibility)
   * @param deleteVisTagFormat The serialization format for the Delete visibility tags. A
   *          <code>null</code> value for this format means the tags are written with unsorted label
   *          ordinals
  ...
  /**
   * Provides a way to modify the visibility tags of type {@link TagType} .VISIBILITY_TAG_TYPE, that
   ...
   * API to provide an opportunity to modify the visibility tags before replicating.
   * @param visTags the visibility tags associated with the cell
   * @param serializationFormat the serialization format associated with the tag
