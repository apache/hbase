...
/**
 * BoundedIncrementSpinAdvancingClock uses AtomicLong#updateAndGet to increment our
 ...
 * at which point it will spin until the system clock catches
 * up.
 */
@InterfaceAudience.Private
public class BoundedIncrementSpinAdvancingClock extends IncrementAdvancingClock {

  static final int MAX_ADVANCE = 1000; // one second in milliseconds

  protected AtomicLong currentAdvance = new AtomicLong(0);

  public BoundedIncrementSpinAdvancingClock(HashedBytes name) {
    super(name);
  }
