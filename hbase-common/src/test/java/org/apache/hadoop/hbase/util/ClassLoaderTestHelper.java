...
public final class ClassLoaderTestHelper {
   ...
   * @param code the optional test class code, which can be null. If null, a bare empty class will
   *          be used
   ...
   * @param className the test class name
   * @param code the optional test class code, which can be null. If null, an empty class will be
   *          used
