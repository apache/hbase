...
public class SplitLogManager {
   ...
   * optionally a filter. See {@link AbstractFSWALProvider#getServerNameFromWALDirectoryName} for
   * more info on directory layout. Should be package-private, but is needed by
  ...
  public long splitLogDistributed(final Set<ServerName> serverNames, final List<Path> logDirs,
    ...
    MonitoredTask status = TaskMonitor.get().createStatus(
      "Doing distributed log split in " + logDirs + " for serverName=" + serverNames);
    long totalSize = 0;
