...
public class ReplicationAdmin implements Closeable {
   ...
   *          from tableName to column family names. An empty collection can be passed to indicate
   *          replicating all column families. Pass null for replicating all table and column
   *          families
