...
public class TestIncrementalBackupWithBulkLoad extends TestBackupBase {
  ...
  public void TestIncBackupDeleteTable() throws Exception {
    ...
    int actual = loadHFiles(testName, table1Desc, TEST_UTIL, famName, qualName, false, null,
    ...
    // #4 bulk load again
    LOG.debug("bulk loading into " + testName);
    int actual1 = loadHFiles(testName, table1Desc, TEST_UTIL, famName, qualName, false, null,
    ...
    assertEquals(TEST_UTIL.countRows(hTable), NB_ROWS_IN_BATCH * 2 + actual + actual1);
  ...
  private static int loadHFiles(String testName, TableDescriptor htd, HBaseTestingUtility util,
