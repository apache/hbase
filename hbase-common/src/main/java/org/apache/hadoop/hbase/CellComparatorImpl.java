 ...
 * will likely manifest at the macro level. See also {@link BBKVComparator}. Use it when mostly
...
public class CellComparatorImpl implements CellComparator {
   ...
   * {{@link MetaCellComparator#META_COMPARATOR} should be used
   * @param left the cell to be compared
   * @param right the kv serialized byte[] to be compared with
   * @param roffset the offset in the byte[]
   * @param rlength the length in the byte[]
