...
public class DefaultMobStoreCompactor extends DefaultCompactor {
  ...
  private final CellSinkFactory<StoreFileWriter> writerFactory =
    new CellSinkFactory<StoreFileWriter>() {
      ...
      public StoreFileWriter createWriter(InternalScanner scanner,
        ...
        boolean shouldDropBehind, Consumer<Path> writerCreationTracker) throws IOException {
        // make this writer with tags always because of possible new cells with tags.
        return store.getStoreEngine()
          .createWriter(createParams(fd, shouldDropBehind, writerCreationTracker)
  ...
  private StoreFileWriter newMobWriter(FileDetails fd) throws IOException {
    try {
