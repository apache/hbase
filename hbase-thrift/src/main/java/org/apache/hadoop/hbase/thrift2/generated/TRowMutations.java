...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.14.1)",
    date = "2021-07-19")
public class TRowMutations implements org.apache.thrift.TBase<TRowMutations, TRowMutations._Fields>,
    java.io.Serializable, Cloneable, Comparable<TRowMutations> {
  ...
  public TRowMutations(java.nio.ByteBuffer row, java.util.List<TMutation> mutations) {
    this();
  ...
  public TRowMutations(TRowMutations other) {
    ...
    if (other.isSetMutations()) {
      java.util.List<TMutation> __this__mutations =
          new java.util.ArrayList<TMutation>(other.mutations.size());
  ...
  public TRowMutations
      setMutations(@org.apache.thrift.annotation.Nullable java.util.List<TMutation> mutations) {
    this.mutations = mutations;
    return this;
  }
  ...
  private static class TRowMutationsStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<TRowMutations> {
  ...
  private static class TRowMutationsTupleScheme
      extends org.apache.thrift.scheme.TupleScheme<TRowMutations> {
