...
Apache HBase runs its unit tests with [JUnit 5](https://junit.org/junit5/). Every unit
...
[tag](https://junit.org/junit5/docs/current/user-guide/#writing-tests-tagging-and-filtering)
...
public class TestExample {
  ...
  //
  // To get the name of the current test method, inject a JUnit 5 TestInfo into your setUp or
  // test methods. See down in 'testExampleFoo()' where we use it to log the current test's name.
