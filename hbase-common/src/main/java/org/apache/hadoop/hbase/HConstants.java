...
public final class HConstants {
  ...
  /**
   * HBASE-1721 implements tiered storage capabilities for bulkload, but it is only applicable to
   * scenarios where hfiles generated by MR/SPARK are directly written to the HDFS cluster used by
   * HBase (tiered storage is configured). However, in most bulkload scenarios, hfiles generated by
   * MR/SPARK are first written to an offline HDFS cluster (non-HBase HDFS Cluster, and tiered
   * storage is not configured). Subsequently, the 'hbase completebulkload' command is used to copy
   * these hfiles from the offline HDFS cluster to the HDFS cluster used by HBase, and rename them
   * to the appropriate table/region/columnfamily directory. This scenario is not supported by
   * HBASE-1721, HBASE-28904 will support tiered storage for this more general bulkload scenario.
   * See HBASE-28904 for details.
   */
  public static final String BULKLOAD_COPYFILE_STORAGE_POLICY_ENABLED_KEY =
    "hbase.bulkload.copyfile.storage-policy.enabled";
  public static final boolean BULKLOAD_COPYFILE_STORAGE_POLICY_ENABLED_DEFAULT = false;
