...
_hbase-website/app/pages/\_docs/docs/\_mdx/(multi-page)_ directory of the HBase source. This reference guide is marked up
...
To protect existing HBase installations from new vulnerabilities, please **do not** use JIRA to report security-related bugs. Instead, send your report to the mailing list security@hbase.apache.org, which allows anyone to send messages, but restricts who can read them. Someone on that list will contact you to follow up on your report.
...
<Callout type="info">
  ...
  sense in which the term _support_ is used in the context of the Apache HBase project. The Apache
