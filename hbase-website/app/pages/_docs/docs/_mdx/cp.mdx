...
[Examples](/docs/cp#examples) provides working examples of observer coprocessors.
...
[Examples](/docs/cp#examples) provides working examples of endpoint coprocessors.
