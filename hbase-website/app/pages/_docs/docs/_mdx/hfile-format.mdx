---
title: "HFile Format"
description: "Evolution and specification of the HBase HFile format across versions 1, 2, and 3."
---
...
| | loadOnOpenOffset (long) _The offset of the section that we need to load when opening the file._ |
...
For more information see [hfilev2.overview](#overview-of-version-2).
...
Within an HFile, HBase cells are stored in data blocks as a sequence of KeyValues (see [hfilev1.overview](#overview-of-version-1), or [Lars George's
