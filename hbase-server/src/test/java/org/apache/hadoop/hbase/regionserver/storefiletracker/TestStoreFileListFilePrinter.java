...
public class TestStoreFileListFilePrinter {
  ...
  private void createTable() throws IOException {
    ...
    TableDescriptor td = TableDescriptorBuilder.newBuilder(tn).setColumnFamily(ColumnFamilyDescriptorBuilder.of(family))
      .setValue(StoreFileTrackerFactory.TRACKER_IMPL, StoreFileTrackerFactory.Trackers.FILE.name()).build();
