...
public class PerformanceEvaluationCommons {
  ...
  public static void assertKey(final byte[] expected, final byte[] gotArray,
    ...
    if (!org.apache.hadoop.hbase.util.Bytes.equals(expected, 0, expected.length, gotArray,
      gotArrayOffset, gotArrayLength)) {
      throw new AssertionError("Expected " + org.apache.hadoop.hbase.util.Bytes.toString(expected)
          + " but got "
