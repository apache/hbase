---
title: "Protobuf in HBase"
description: "In this chapter we go into detail for developers who are looking to understand better how Protobuf in HBase works. This chapter is of particular use to those who would amend or extend HBase functionality."
---
...
[RPCs](#hbase-rpc). HBase uses protobufs to describe the RPC
...
[Coprocessor Endpoint](#cp) mechanism.
...
[hbase-2.0.0](#shaded-protobuf) section.
