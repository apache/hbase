...
WARNING: This step will permanently destroy all replication peers. Please see the section on HBase Replication under Caveats for more information.
...
#### Copy the HBase data directory to a backup location
...
#### Restore the HBase data directory from prior to the upgrade
