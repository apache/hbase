---
title: "ZooKeeper"
description: "How to configure and use Apache ZooKeeper with HBase including SASL authentication and TLS connections."
---
...
For all default values used by HBase, including ZooKeeper configuration, see [hbase default configurations](#hbase-default-configurations).
...
<Callout title="How many ZooKeepers should I run?">
