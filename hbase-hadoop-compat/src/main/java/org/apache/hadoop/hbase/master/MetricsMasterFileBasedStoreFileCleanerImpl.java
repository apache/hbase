...
/**
 * Implementation of {@link MetricsMasterFileBasedStoreFileCleaner} to track latencies for one table
 * in a RegionServer.
 */
@InterfaceAudience.Private public class MetricsMasterFileBasedStoreFileCleanerImpl extends BaseSourceImpl
  implements MetricsMasterFileBasedStoreFileCleaner {
  ...
  public MetricsMasterFileBasedStoreFileCleanerImpl(String metricsName, String metricsDescription,
    String metricsContext, String metricsJmxContext) {
    super(metricsName, metricsDescription, metricsContext, metricsJmxContext);

    fileBasedStoreFileCleanerDeletes = getMetricsRegistry().newCounter(DELETES, DELETES_DESC, 0l);
    fileBasedStoreFileCleanerFailedDeletes =
  ...
  public MetricsMasterFileBasedStoreFileCleanerImpl() {
  ...
  @Override public void incrementFileBasedStoreFileCleanerRuns(long runs) {
    fileBasedStoreFileCleanerRuns.incr(runs);
  }
