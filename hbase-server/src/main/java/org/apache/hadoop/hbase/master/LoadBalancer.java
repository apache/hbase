 ...
 * transition and according to a fixed period of a time using {@link #clusterBalancePlans(Map)}.
 *
...
public interface LoadBalancer extends Configurable, Stoppable, ConfigurationObserver {
  ...
  /**
   * Perform the major balance operation for cluster, will invoke {@link #tableBalancePlans} to do
   ...
   *         already balanced
   */
  List<RegionPlan> clusterBalancePlans(Map<TableName,
   ...
   */
  List<RegionPlan> tableBalancePlans(TableName tableName,
