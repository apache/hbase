...
public class IntegrationTestIngest extends IntegrationTestBase {
  ...
  protected String[] LOAD_TEST_TOOL_INIT_ARGS = { LoadTestTool.OPT_COLUMN_FAMILIES,
      LoadTestTool.OPT_COMPRESSION, HFileTestUtil.OPT_DATA_BLOCK_ENCODING,
      LoadTestTool.OPT_INMEMORY, LoadTestTool.OPT_ENCRYPTION,
  ...
  protected void internalRunIngestTest(long runTime) throws Exception {
    ...
    int numWriteThreads = conf.getInt(String.format("%s.%s", clazz, NUM_WRITE_THREADS_KEY),
