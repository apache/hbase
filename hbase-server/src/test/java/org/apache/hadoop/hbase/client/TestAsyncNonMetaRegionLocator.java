...
public class TestAsyncNonMetaRegionLocator {
  ...
  public static void setUp() throws Exception {
    ...
    // Enable hbase:meta replication.
    HBaseTestingUtility.setReplicas(admin, TableName.META_TABLE_NAME, NUM_OF_META_REPLICA);
  ...
  public void testRemoveCachedLocationForServerOnError() throws Exception {
    ...
    try(Table ignored = TEST_UTIL.createTable(tableName2, FAMILY, SPLIT_KEYS)) {
      ...
      Map<TableName, List<RegionInfo>> tableToRegions = new HashMap<TableName, List<RegionInfo>>(){
        {
