---
title: "Security"
description: "Comprehensive guide to HBase security including authentication, authorization, encryption, and access control."
---
# 
...
3.  Enable secure communication on the Region Servers in both *server and client* mode with plaintext support. Client mode here will ensure that RegionServer’s communication to Master is encrypted.
...
<tbody>
<tr>
<td style={{textAlign: "left"}}><pre><code> fulltime</code></pre></td>
<td style={{textAlign: "left"}}><p>Allow access to users associated with the fulltime label.</p></td>
</tr>
<tr>
<td style={{textAlign: "left"}}><pre><code> !public</code></pre></td>
<td style={{textAlign: "left"}}><p>Allow access to users not associated with the public label.</p></td>
</tr>
<tr>
<td style={{textAlign: "left"}}><pre><code> ( secret | topsecret ) &amp; !probationary</code></pre></td>
<td style={{textAlign: "left"}}><p>Allow access to users associated with either the secret or topsecret label and not associated with the probationary label.</p></td>
</tr>
</tbody>
</table>
...
2.  Configure permissions on the *hbase-site.xml* file.
