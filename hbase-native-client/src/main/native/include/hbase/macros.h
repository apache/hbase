...
*/
#ifndef LIBHBASE_MACROS_H_
#define LIBHBASE_MACROS_H_
...
/**
 * The following code block define HBASE_API as the tag for exported
 ...
 */
      ...
      #define HBASE_API __declspec(dllexport)
  #else
    #ifdef USE_STATIC_LIBHBASE
      #define HBASE_API
    #else
