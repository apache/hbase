...
For all default values used by HBase, including ZooKeeper configuration, see [hbase default configurations](/docs/configuration/default#hbase-default-configuration).
