 ...
 */
public abstract class SnapshotCloneIndependenceTestBase {

  private static final Logger LOG =
    LoggerFactory.getLogger(SnapshotCloneIndependenceTestBase.class);
  ...
  public void setup(TestInfo testInfo) throws Exception {
    ...
    LOG.info("Original table has: " + countOriginalTable + " rows");
  }
