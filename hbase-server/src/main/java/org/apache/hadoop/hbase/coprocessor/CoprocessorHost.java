...
public abstract class CoprocessorHost<C extends Coprocessor, E extends CoprocessorEnvironment<C>> {
  ...
  /**
   * Get the full class names of all loaded coprocessors.
   * This method returns the complete class names including package information,
   * which is useful for precise coprocessor identification and comparison.
   */
