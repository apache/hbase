...
public class TestDefaultOperationQuota {
  ...
  public void testLargeBatchSaturatesReadNumLimit()
    ...
    DefaultOperationQuota quota = new DefaultOperationQuota(new Configuration(), 65536,
  ...
  public void testTooLargeReadSizeIsNotBlocked()
    ...
    DefaultOperationQuota quota =
      new DefaultOperationQuota(new Configuration(), (int) blockSize, DEFAULT_REQUESTS_PER_SECOND, limiter);
