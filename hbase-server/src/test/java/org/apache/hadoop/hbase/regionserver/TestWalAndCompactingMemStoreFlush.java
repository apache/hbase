...
public class TestWalAndCompactingMemStoreFlush {
  ...
  public void testSelectiveFlushWithEager() throws IOException {
    ...
    s = s + "The smallest sequence in region WAL is: " + smallestSeqInRegionCurrentMemstorePhaseII
        ...
        + "the smallest sequence in CF2:" + smallestSeqCF2PhaseII
    ...
    s = s + "The smallest sequence in region WAL is: " + smallestSeqInRegionCurrentMemstorePhaseIV
        ...
        + "the smallest sequence in CF2:" + smallestSeqCF2PhaseIV
        + ", the smallest sequence in CF3:" + smallestSeqCF3PhaseIV + "\n";
  ...
  public void testSelectiveFlushAndWALinDataCompaction() throws IOException {
    ...
    String s =
        "\n\n----------------------------------\n" + "Upon initial insert and flush, LSN of CF1 is:"
            + smallestSeqCF1PhaseII + ". LSN of CF2 is:" + smallestSeqCF2PhaseII
            + ". LSN of CF3 is:" + smallestSeqCF3PhaseII + ", smallestSeqInRegionCurrentMemstore:"
    ...
    s = s + "The smallest sequence in region WAL is: " + smallestSeqInRegionCurrentMemstorePhaseIII
        ...
        + "the smallest sequence in CF2:" + smallestSeqCF2PhaseIII
        + ", the smallest sequence in CF3:" + smallestSeqCF3PhaseIII + "\n";
  ...
  public void testSelectiveFlushWithBasicAndMerge() throws IOException {
    ...
    assertEquals(
      "\n<<< DEBUG: The data--heap sizes of stores before/after first flushes," + " CF1: "
          + cf1MemstoreSizePhaseI.getDataSize() + "/" + cf1MemstoreSizePhaseII.getDataSize() + "--"
          + cf1MemstoreSizePhaseI.getHeapSize() + "/" + cf1MemstoreSizePhaseII.getHeapSize()
          + ", CF2: " + cf2MemstoreSizePhaseI.getDataSize() + "/"
          ...
          + " CF1: " + cf1MemstoreSizePhaseIII.getDataSize() + "/"
