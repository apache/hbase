...
public class MobSlowDeterministicMonkeyFactory extends MonkeyFactory {
  ...
  public ChaosMonkey build() {
    ...
    Action[] actions1 = new Action[] { new CompactMobAction(tableName, compactTableRatio),
    ...
    return new PolicyBasedChaosMonkey(properties, util,
        ...
        new CompositeSequentialPolicy(new DoActionsOncePolicy(action3Period, actions3),
  ...
  private void loadProperties() {
    ...
    restartRsHoldingMetaSleepTime = Long
        .parseLong(this.properties.getProperty(MonkeyConstants.RESTART_RS_HOLDING_META_SLEEP_TIME,
