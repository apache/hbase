...
public class TestLogRollProcedure {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(TestLogRollProcedure.class);

  private Configuration conf;

  private TableName backupSystemTable;
  ...
  public void setUp() throws Exception {
    ...
    backupSystemTable = BackupSystemTable.getTableName(conf);
  ...
  public void testSimpleLogRoll() throws IOException {
    ...
    BackupUtils.logRoll(props, conf);
