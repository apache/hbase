...
<div id="hbase.fix.version.in.jira" class="formalpara">
...
<div id="hbase.when.to.close.jira" class="formalpara">
...
<div id="no.permanent.state.in.zk" class="formalpara">
...
| 2.5 | Andrew Purtell | Check the [download](https://hbase.apache.org/downloads.html) page | **NOT YET** |
| 2.6 | Bryan Beaudreault | Check the [download](https://hbase.apache.org/downloads.html) page | **NOT YET** |
