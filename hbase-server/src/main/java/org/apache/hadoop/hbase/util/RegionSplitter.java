...
public class RegionSplitter {
   ...
   * @param args Usage: RegionSplitter &lt;TABLE&gt; &lt;SPLITALGORITHM&gt; &lt;-c &lt;# regions&gt;
   *          -f &lt;family:family:...&gt; | -r [-o &lt;# outstanding splits&gt;]&gt; [-D
   *          &lt;conf.param=value&gt;]
  ...
  public static void main(String[] args) throws IOException, InterruptedException, ParseException {
    ...
    opt.addOption(OptionBuilder.withArgName("family:family:...").hasArg()
        .withDescription("Column Families to create with new table.  Required with -c")
        .create("f"));
        ...
        try {
          ...
          try {
            ...
            while (!daughterRegions.isEmpty()) {
              ...
              for (Map.Entry<ServerName, LinkedList<Pair<byte[], byte[]>>> daughterRegion : daughterRegions
                  .entrySet()) {
