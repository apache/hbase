...
public class ReplicationSourceManager implements ReplicationListener {
  ...
  public ReplicationSourceManager(ReplicationQueueStorage queueStorage,
    ...
    WALFactory walFactory, MetricsReplicationGlobalSourceSource globalMetrics) throws IOException {
    ...
    public void run() {
      ...
      try {
        ...
        LOG.error(String.format(
          "ReplicationException: cannot claim dead region (%s)'s "
        ...
        try {
          ...
          if (
            ...
            LOG.warn("Peer {} is disabled. ReplicationSyncUp tool will skip "
              + "replicating data to this peer.", actualPeerId);
            continue;
          }
