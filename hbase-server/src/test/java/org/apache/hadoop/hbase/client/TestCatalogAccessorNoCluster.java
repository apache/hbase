...
public class TestCatalogAccessorNoCluster {
  ...
  public void testGetHRegionInfo() throws IOException {
    assertNull(CatalogAccessor.getRegionInfo(new Result()));

    List<Cell> kvs = new ArrayList<>();
    Result r = Result.create(kvs);
    assertNull(CatalogAccessor.getRegionInfo(r));
    ...
    RegionInfo hri = CatalogAccessor.getRegionInfo(Result.create(kvs));
    assertTrue(hri == null);
    ...
    hri = CatalogAccessor.getRegionInfo(Result.create(kvs));
    assertNotNull(hri);
