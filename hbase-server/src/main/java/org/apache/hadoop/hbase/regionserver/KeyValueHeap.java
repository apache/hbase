...
public class KeyValueHeap extends NonReversedNonLazyKeyValueScanner
  ...
  /**
   * @param isLazy whether we are trying to seek to exactly the given row/col. Enables Bloom filter
   *          and most-recent-file-first optimizations for multi-column get/scan queries.
