...
description: "Configuring Kerberos-based secure authentication for HBase clients, including server and client setup procedures."
---
...
First, refer to [security.prerequisites](/docs/security/client-access#prerequisites) and ensure that your underlying HDFS configuration is secure.
...
First, refer to [Prerequisites](/docs/security/client-access#prerequisites) and ensure that your underlying HDFS configuration is secure.
