...
HBase used to depend on the HTrace project for tracing. After the Apache HTrace project moved to the Attic/retired, we decided to move to [OpenTelemetry](https://opentelemetry.io) in [HBASE-22120](https://issues.apache.org/jira/browse/HBASE-22120).
