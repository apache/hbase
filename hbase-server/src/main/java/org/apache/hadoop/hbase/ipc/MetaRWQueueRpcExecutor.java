...
public class MetaRWQueueRpcExecutor extends RWQueueRpcExecutor {
  ...
  private static final String META_CALL_QUEUE_HANDLER_FACTOR_CONF_KEY =
  ...
  public boolean dispatch(CallRunner callTask) {
    ...
    // dispatch master system read request to scan handlers
    final boolean toScanQueue = getNumScanQueues() > 0 && level == HConstants.MASTER_HIGH_QOS;
