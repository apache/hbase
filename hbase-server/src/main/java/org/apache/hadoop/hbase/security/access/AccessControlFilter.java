...
class AccessControlFilter extends FilterBase {
  ...
  public ReturnCode filterCell(final Cell cell) {
    ...
    if (prevFam.getBytes() == null || !(PrivateCellUtil.matchingFamily(cell, prevFam.getBytes(),
    ...
    if (prevQual.getBytes() == null || !(PrivateCellUtil.matchingQualifier(cell,
      prevQual.getBytes(), prevQual.getOffset(), prevQual.getLength()))) {
