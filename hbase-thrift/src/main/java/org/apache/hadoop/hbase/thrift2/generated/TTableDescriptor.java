...
public class TTableDescriptor
    implements org.apache.thrift.TBase<TTableDescriptor, TTableDescriptor._Fields>,
  ...
  public TTableDescriptor(TTableDescriptor other) {
    ...
    if (other.isSetColumns()) {
      java.util.List<TColumnFamilyDescriptor> __this__columns =
          new java.util.ArrayList<TColumnFamilyDescriptor>(other.columns.size());
    ...
    if (other.isSetAttributes()) {
      java.util.Map<java.nio.ByteBuffer, java.nio.ByteBuffer> __this__attributes =
          new java.util.HashMap<java.nio.ByteBuffer, java.nio.ByteBuffer>(other.attributes);
  ...
  public TTableDescriptor setColumns(
      @org.apache.thrift.annotation.Nullable java.util.List<TColumnFamilyDescriptor> columns) {
  ...
  public TTableDescriptor setAttributes(
      @org.apache.thrift.annotation.Nullable java.util.Map<java.nio.ByteBuffer, java.nio.ByteBuffer> attributes) {
  ...
  private static class TTableDescriptorStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<TTableDescriptor> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.attributes = new java.util.HashMap<java.nio.ByteBuffer, java.nio.ByteBuffer>(
                    2 * _map165.size);
                @org.apache.thrift.annotation.Nullable
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter170 : struct.attributes
                .entrySet()) {
  ...
  private static class TTableDescriptorTupleScheme
      extends org.apache.thrift.scheme.TupleScheme<TTableDescriptor> {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter172 : struct.attributes
              .entrySet()) {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.attributes =
              new java.util.HashMap<java.nio.ByteBuffer, java.nio.ByteBuffer>(2 * _map176.size);
          @org.apache.thrift.annotation.Nullable
