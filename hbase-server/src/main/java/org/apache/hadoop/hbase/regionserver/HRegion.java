...
public class HRegion implements HeapSize, PropagatingConfigurationObserver, Region {
  ...
  private long initializeRegionInternals(final CancelableProgressable reporter,
    ...
    LOG.info("Opened {}; next sequenceid={}; {}, useLinkFileWhenSplit={}, {}",
      this.getRegionInfo().getShortNameToLog(), nextSeqId, this.splitPolicy,
      this.splitPolicy.isLinkFileEnabledInSplit(), this.flushPolicy);
