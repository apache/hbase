...
public class MetricsHeapMemoryManagerSourceImpl extends BaseSourceImpl
  ...
  public MetricsHeapMemoryManagerSourceImpl(String metricsName, String metricsDescription,
    ...
    incBlockCacheSizeHistogram = getMetricsRegistry().newSizeHistogram(INC_BLOCKCACHE_TUNING_NAME,
      INC_BLOCKCACHE_TUNING_DESC);
    decBlockCacheSizeHistogram = getMetricsRegistry().newSizeHistogram(DEC_BLOCKCACHE_TUNING_NAME,
    ...
    aboveHeapOccupancyLowWatermarkCounter = getMetricsRegistry().newCounter(
      ABOVE_HEAP_LOW_WATERMARK_COUNTER_NAME, ABOVE_HEAP_LOW_WATERMARK_COUNTER_DESC, 0L);
  }
