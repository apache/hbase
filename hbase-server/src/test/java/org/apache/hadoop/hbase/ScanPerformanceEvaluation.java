...
public class ScanPerformanceEvaluation extends AbstractHBaseTool {
  ...
  protected void testHdfsStreaming(Path filename) throws IOException {
    ...
    System.out.println("total time to open: " + fileOpenTimer.elapsed(MILLISECONDS) + " ms");
    System.out.println("total time to read: " + streamTimer.elapsed(MILLISECONDS) + " ms");
  ...
  public void testScan() throws IOException {
    ...
    System.out.println("total time to open table: " + tableOpenTimer.elapsed(MILLISECONDS) + " ms");
    System.out.println("total time to open scanner: " + scanOpenTimer.elapsed(MILLISECONDS) + " ms");
    System.out.println("total time to scan: " + scanTimer.elapsed(MILLISECONDS) + " ms");
  ...
  public void testSnapshotScan() throws IOException {
    ...
    System.out.println("total time to restore snapshot: " + snapshotRestoreTimer.elapsed(MILLISECONDS) + " ms");
    System.out.println("total time to open scanner: " + scanOpenTimer.elapsed(MILLISECONDS) + " ms");
    System.out.println("total time to scan: " + scanTimer.elapsed(MILLISECONDS) + " ms");
