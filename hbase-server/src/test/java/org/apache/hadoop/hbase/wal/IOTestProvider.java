...
public class IOTestProvider implements WALProvider {
  ...
  private static class IOTestWAL extends FSHLog {
     ...
     * @param listeners Listeners on WAL events. Listeners passed here will be registered before we
     *          do anything else; e.g. the Constructor {@link #rollWriter()}.
