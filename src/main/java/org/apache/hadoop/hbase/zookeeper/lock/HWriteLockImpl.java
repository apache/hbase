 ...
 */
public class HWriteLockImpl extends BaseHLockImpl {

  private static final Log LOG = LogFactory.getLog(HWriteLockImpl.class);

  public HWriteLockImpl(ZooKeeperWrapper zooKeeperWrapper,
      String name, byte[] metadata, MetadataHandler handler) {
    super(zooKeeperWrapper, name, metadata, handler, WRITE_LOCK_CHILD_NODE);
  }
