...
public final class Constants {
  ...
  public static final String THRIFT_SSL_SERVER_KEYSTORE_PASSWORD_KEY =
    "hbase.thrift.ssl.server.keystore.password";
  public static final String THRIFT_SSL_SERVER_KEYSTORE_KEYPASSWORD_KEY =
    "hbase.thrift.ssl.server.keystore.keypassword";
  public static final String THRIFT_SSL_SERVER_KEYSTORE_TYPE_KEY =
    "hbase.thrift.ssl.server.keystore.type";
  public static final String THRIFT_SSL_SERVER_TRUSTSTORE_STORE_KEY =
    "hbase.thrift.ssl.server.truststore.store";
  public static final String THRIFT_SSL_SERVER_TRUSTSTORE_PASSWORD_KEY =
    "hbase.thrift.ssl.server.truststore.password";
  public static final String THRIFT_SSL_SERVER_TRUSTSTORE_TYPE_KEY =
    "hbase.thrift.ssl.server.truststore.type";
