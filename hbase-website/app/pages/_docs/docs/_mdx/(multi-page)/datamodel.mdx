...
### Scans [#data-model-operations-scans]
...
See [hbase.column.max.version](#todo).
...
anymore..._ (See _Garbage Collection_ in [Bending time in HBase](https://web.archive.org/web/20160909085951/https://www.ngdata.com/bending-time-in-hbase/).)
