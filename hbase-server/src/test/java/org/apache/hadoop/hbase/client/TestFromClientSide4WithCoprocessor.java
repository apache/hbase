...
public class TestFromClientSide4WithCoprocessor extends FromClientSideTest4 {

  protected TestFromClientSide4WithCoprocessor(Class<? extends ConnectionRegistry> registryImpl,
    int numHedgedReqs) {
