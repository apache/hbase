...
public class TestMetricsReplicationSourceRefresherChore {
	...
	public static final HBaseClassTestRule CLASS_RULE = HBaseClassTestRule
			.forClass(TestMetricsReplicationSourceRefresherChore.class);
	...
	public void testOldestWalAgeMetricsRefresherCore() {
	    ...
	    MetricsReplicationSourceRefresherChore mrsrChore  = new MetricsReplicationSourceRefresherChore(10, rs, mockSource);
	    ...
	    PriorityBlockingQueue<Path> queue = new PriorityBlockingQueue<>(1, new AbstractFSWALProvider.WALStartTimeComparator());
	    queue.put(log1);
