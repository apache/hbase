...
public class TestOrderedBytes {
  ...
  static final Double[] D_VALS = { 0.0, 0.00123, 0.0123, 0.123, 1.0, 10.0, 12.345, 99.0, 99.01,
      99.0001, 100.0, 100.01, 100.1, 1234.0, 1234.5, 9999.0, 9999.000001, 9999.000009, 9999.00001,
      9999.00009, 9999.000099, 9999.0001, 9999.001, 9999.01, 9999.1, 10000.0, 10001.0, 12345.0,
      123450.0, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NaN, Double.MAX_VALUE,
      ...
      -123450.0 };
  static final int[] D_LENGTHS = { 1, 4, 4, 4, 2, 2, 4, 2, 3, 4, 2, 4, 4, 3, 4, 3, 6, 6, 6, 6, 6, 5,
      5, 4, 4, 2, 4, 4, 4, 1, 1, 1, 11, 4, 4, 4, 2, 2, 4, 2, 3, 4, 2, 4, 4, 3, 4, 3, 6, 6, 6, 6, 6,
      5, 5, 4, 4, 2, 4, 4, 4 };
  ...
  public void testEncodeDecodeMatch() {
    ...
    for (int i = 0; i < samplesQuantity; i++) {
      BigDecimal randomData = BigDecimal.valueOf(
        ThreadLocalRandom.current().nextDouble() + ThreadLocalRandom.current().nextLong());
