...
public class BatchMutation implements org.apache.thrift.TBase<BatchMutation, BatchMutation._Fields>,
  ...
  public BatchMutation(java.nio.ByteBuffer row, java.util.List<Mutation> mutations) {
    this();
  ...
  public BatchMutation(BatchMutation other) {
    ...
    if (other.isSetMutations()) {
      java.util.List<Mutation> __this__mutations =
          new java.util.ArrayList<Mutation>(other.mutations.size());
  ...
  public BatchMutation
      setMutations(@org.apache.thrift.annotation.Nullable java.util.List<Mutation> mutations) {
    this.mutations = mutations;
    return this;
  }
  ...
  private static class BatchMutationStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<BatchMutation> {
  ...
  private static class BatchMutationTupleScheme
      extends org.apache.thrift.scheme.TupleScheme<BatchMutation> {
