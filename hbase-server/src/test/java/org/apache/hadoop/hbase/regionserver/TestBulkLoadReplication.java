...
//  private static Table htable4;
  ...
  public void setUpBase() throws Exception {
    ...
    getReplicationAdmin(utility1.getConfiguration()).addPeer(PEER_ID4, peer4Config, null);
    //adds cluster1 as a remote peer on cluster4
    ReplicationAdmin admin4 = getReplicationAdmin(utility4.getConfiguration());
    admin4.addPeer(PEER_ID1, peer1Config, null);
    //adds cluster3 as a remote peer on cluster4
    admin4.addPeer(PEER_ID3, peer3Config, null);
    //adds cluster4 as a remote peer on cluster3
    getReplicationAdmin(utility3.getConfiguration()).addPeer(PEER_ID4, peer4Config, null);
