...
/**
 * For internal purpose. {@link Tag} and memstoreTS/mvcc are internal implementation detail that
 * should not be exposed publicly. Use {@link ExtendedCellBuilderFactory} to get ExtendedCellBuilder
