...
description: "Setting up synchronous replication between HBase clusters for strong consistency and automatic failover capabilities."
---

## Background [#sync-replication-background]
