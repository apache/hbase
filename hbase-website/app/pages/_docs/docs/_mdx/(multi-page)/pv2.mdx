---
title: "Procedure Framework (PV2)"
description: "Procedure v2 ...aims to provide a unified way to build...multi-step procedures with a rollback/roll-forward ability in case of failure (e.g. create/delete table) — Matteo Bertozzi, the author of Pv2."
---
...
### Metrics [#pv2-procedures-metrics]
