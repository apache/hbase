...
public class TestOrderedNumeric {
  ...
  private static final Double[] DOUBLE_VALUES = new Double[] { Double.NaN, 1.1, 22.2, 333.3, 4444.4,
      55555.5, 666666.6, 7777777.7, 88888888.8, 999999999.9 };

  private static final BigDecimal[] BIG_DECIMAL_VALUES =
      new BigDecimal[] { new BigDecimal(1), new BigDecimal(22), new BigDecimal(333),
          new BigDecimal(4444), new BigDecimal(55555), new BigDecimal(666666),
          new BigDecimal(7777777), new BigDecimal(88888888), new BigDecimal(999999999) };

  private static final BigInteger[] BIG_INTEGER_VALUES =
      new BigInteger[] { new BigInteger("1"), new BigInteger("22"), new BigInteger("333"),
