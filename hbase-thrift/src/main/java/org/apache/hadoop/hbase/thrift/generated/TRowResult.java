...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.14.1)",
    date = "2021-07-19")
public class TRowResult implements org.apache.thrift.TBase<TRowResult, TRowResult._Fields>,
    java.io.Serializable, Cloneable, Comparable<TRowResult> {
  ...
  public TRowResult(TRowResult other) {
    ...
    if (other.isSetColumns()) {
      java.util.Map<java.nio.ByteBuffer, TCell> __this__columns =
          new java.util.HashMap<java.nio.ByteBuffer, TCell>(other.columns.size());
      for (java.util.Map.Entry<java.nio.ByteBuffer, TCell> other_element : other.columns
          .entrySet()) {
    ...
    if (other.isSetSortedColumns()) {
      java.util.List<TColumn> __this__sortedColumns =
          new java.util.ArrayList<TColumn>(other.sortedColumns.size());
  ...
  public TRowResult setColumns(
      @org.apache.thrift.annotation.Nullable java.util.Map<java.nio.ByteBuffer, TCell> columns) {
  ...
  public TRowResult setSortedColumns(
      @org.apache.thrift.annotation.Nullable java.util.List<TColumn> sortedColumns) {
  ...
  private static class TRowResultStandardScheme
      extends org.apache.thrift.scheme.StandardScheme<TRowResult> {
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.nio.ByteBuffer, TCell> _iter15 : struct.columns
                .entrySet()) {
  ...
  private static class TRowResultTupleScheme
      extends org.apache.thrift.scheme.TupleScheme<TRowResult> {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, TCell> _iter17 : struct.columns
              .entrySet()) {
