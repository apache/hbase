...
public final class SemanticAttributes {
  public static final AttributeKey<String> DB_SYSTEM =
    io.opentelemetry.semconv.trace.attributes.SemanticAttributes.DB_SYSTEM;
  public static final String DB_SYSTEM_VALUE =
    io.opentelemetry.semconv.trace.attributes.SemanticAttributes.DbSystemValues.HBASE;
  public static final AttributeKey<String> DB_CONNECTION_STRING =
    io.opentelemetry.semconv.trace.attributes.SemanticAttributes.DB_CONNECTION_STRING;
  public static final AttributeKey<String> DB_USER =
    io.opentelemetry.semconv.trace.attributes.SemanticAttributes.DB_USER;
  public static final AttributeKey<String> DB_NAME =
    io.opentelemetry.semconv.trace.attributes.SemanticAttributes.DB_NAME;
  public static final AttributeKey<String> NAMESPACE_KEY =
    io.opentelemetry.semconv.trace.attributes.SemanticAttributes.DB_HBASE_NAMESPACE;
  public static final AttributeKey<String> DB_OPERATION =
    io.opentelemetry.semconv.trace.attributes.SemanticAttributes.DB_OPERATION;
  ...
  public static final AttributeKey<String> REMOTE_HOST_KEY =
    io.opentelemetry.semconv.trace.attributes.SemanticAttributes.NET_PEER_NAME;
  public static final AttributeKey<Long> REMOTE_PORT_KEY =
    io.opentelemetry.semconv.trace.attributes.SemanticAttributes.NET_PEER_PORT;
