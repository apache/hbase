...
public class ShadeProviderSelector extends BuiltInProviderSelector {
  ...
  public void configure(Configuration conf,
    ...
    this.shade = (ShadeSaslClientAuthenticationProvider) providers.stream()
        .filter((p) -> p instanceof ShadeSaslClientAuthenticationProvider).findFirst().orElseThrow(
          () -> new RuntimeException("ShadeSaslClientAuthenticationProvider not loaded"));
  }
