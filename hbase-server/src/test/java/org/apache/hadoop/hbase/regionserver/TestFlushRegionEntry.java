...
public class TestFlushRegionEntry {
  ...
  public void testFlushRegionEntryEquality() {
    ...
    FlushRegionEntry entry = new FlushRegionEntry(r, true, null, FlushLifeCycleTracker.DUMMY);
    FlushRegionEntry other = new FlushRegionEntry(r, true, null, FlushLifeCycleTracker.DUMMY);
