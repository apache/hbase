...
/**
 * The default implementation of StoreFileManager, Not thread-safe
 *
 * It's also the base class for any additional logic built on top of the default implementation.
 */
@InterfaceAudience.Private
abstract class AbstractStoreFileManager implements StoreFileManager {
  ...
  public AbstractStoreFileManager(CellComparator cellComparator,
  ...
  /**
   * additional logic after loadFiles() if any
   * newCompactedfiles the if any
   *
   * @param storeFiles a list of store files to be processed
   */
  protected abstract void loadFilesHook(ImmutableList<HStoreFile> storeFiles) throws IOException;

  /**
   * additional logic after insertNewFiles() if any
   * @param storeFiles a list of store files to be processed
   */
  protected abstract void insertNewFilesHook(ImmutableList<HStoreFile> storeFiles)
    throws IOException;
   ...
   *
   */
  protected abstract void addCompactionResultsHook(ImmutableList<HStoreFile> storeFiles)
    throws IOException;
