...
public class OrderedBytes {
  ...
  public static boolean isFixedInt8(PositionedByteRange src) {
    return FIXED_INT8 == (-1 == Integer.signum(src.peek()) ? DESCENDING : ASCENDING)
        .apply(src.peek());
  }
  ...
  public static boolean isFixedInt16(PositionedByteRange src) {
    return FIXED_INT16 == (-1 == Integer.signum(src.peek()) ? DESCENDING : ASCENDING)
        .apply(src.peek());
  }
  ...
  public static boolean isFixedInt32(PositionedByteRange src) {
    return FIXED_INT32 == (-1 == Integer.signum(src.peek()) ? DESCENDING : ASCENDING)
        .apply(src.peek());
  }
  ...
  public static boolean isFixedInt64(PositionedByteRange src) {
    return FIXED_INT64 == (-1 == Integer.signum(src.peek()) ? DESCENDING : ASCENDING)
        .apply(src.peek());
  }
  ...
  public static boolean isFixedFloat32(PositionedByteRange src) {
    return FIXED_FLOAT32 == (-1 == Integer.signum(src.peek()) ? DESCENDING : ASCENDING)
        .apply(src.peek());
  }
  ...
  public static boolean isFixedFloat64(PositionedByteRange src) {
    return FIXED_FLOAT64 == (-1 == Integer.signum(src.peek()) ? DESCENDING : ASCENDING)
        .apply(src.peek());
  }
  ...
  public static boolean isBlobVar(PositionedByteRange src) {
    return BLOB_VAR == (-1 == Integer.signum(src.peek()) ? DESCENDING : ASCENDING)
        .apply(src.peek());
  }
  ...
  public static boolean isBlobCopy(PositionedByteRange src) {
    return BLOB_COPY == (-1 == Integer.signum(src.peek()) ? DESCENDING : ASCENDING)
        .apply(src.peek());
  }
