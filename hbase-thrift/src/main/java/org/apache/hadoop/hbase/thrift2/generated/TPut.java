...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.14.1)",
    date = "2021-03-24")
public class TPut implements org.apache.thrift.TBase<TPut, TPut._Fields>, java.io.Serializable,
    Cloneable, Comparable<TPut> {
  ...
  public TPut(java.nio.ByteBuffer row, java.util.List<TColumnValue> columnValues) {
    this();
  ...
  public TPut(TPut other) {
    ...
    if (other.isSetColumnValues()) {
      java.util.List<TColumnValue> __this__columnValues =
          new java.util.ArrayList<TColumnValue>(other.columnValues.size());
  ...
  public TPut setColumnValues(
      @org.apache.thrift.annotation.Nullable java.util.List<TColumnValue> columnValues) {
    this.columnValues = columnValues;
    return this;
  }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter42 : struct.attributes
                .entrySet()) {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter44 : struct.attributes
              .entrySet()) {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.attributes =
              new java.util.HashMap<java.nio.ByteBuffer, java.nio.ByteBuffer>(2 * _map48.size);
          @org.apache.thrift.annotation.Nullable
