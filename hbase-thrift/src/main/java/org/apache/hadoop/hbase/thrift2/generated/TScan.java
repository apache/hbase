...
public class TScan implements org.apache.thrift.TBase<TScan, TScan._Fields>, java.io.Serializable,
  ...
  public TScan(TScan other) {
    ...
    if (other.isSetColFamTimeRangeMap()) {
      java.util.Map<java.nio.ByteBuffer, TTimeRange> __this__colFamTimeRangeMap =
          new java.util.HashMap<java.nio.ByteBuffer, TTimeRange>(other.colFamTimeRangeMap.size());
      for (java.util.Map.Entry<java.nio.ByteBuffer, TTimeRange> other_element : other.colFamTimeRangeMap
          .entrySet()) {
  ...
  public TScan setColFamTimeRangeMap(
      @org.apache.thrift.annotation.Nullable java.util.Map<java.nio.ByteBuffer, TTimeRange> colFamTimeRangeMap) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.colFamTimeRangeMap =
                    new java.util.HashMap<java.nio.ByteBuffer, TTimeRange>(2 * _map113.size);
                @org.apache.thrift.annotation.Nullable
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter118 : struct.attributes
                .entrySet()) {
      ...
      if (struct.colFamTimeRangeMap != null) {
        if (struct.isSetColFamTimeRangeMap()) {
          oprot.writeFieldBegin(COL_FAM_TIME_RANGE_MAP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.nio.ByteBuffer, TTimeRange> _iter119 : struct.colFamTimeRangeMap
                .entrySet()) {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, java.nio.ByteBuffer> _iter121 : struct.attributes
              .entrySet()) {
      ...
      if (struct.isSetColFamTimeRangeMap()) {
        {
          ...
          for (java.util.Map.Entry<java.nio.ByteBuffer, TTimeRange> _iter122 : struct.colFamTimeRangeMap
              .entrySet()) {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.attributes =
              new java.util.HashMap<java.nio.ByteBuffer, java.nio.ByteBuffer>(2 * _map126.size);
          @org.apache.thrift.annotation.Nullable
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.colFamTimeRangeMap =
              new java.util.HashMap<java.nio.ByteBuffer, TTimeRange>(2 * _map130.size);
          @org.apache.thrift.annotation.Nullable
