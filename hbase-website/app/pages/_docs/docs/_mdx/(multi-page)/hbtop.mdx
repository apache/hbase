---
title: "hbtop"
description: "hbtop is a real-time monitoring tool for HBase like Unix's top command. It can display summary information as well as metrics per Region/Namespace/Table/RegionServer. In this tool, you can see the metrics sorted by a selected field and filter the metrics to see only metrics you really want to see."
---
...
![Top screen](/docs-images/top_screen.gif)
...
![Scrolling metric records](/docs-images/scrolling_metric_records.gif)
...
![Changing mode](/docs-images/changing_mode.gif)

### Changing the refresh delay

You can change the refresh by pressing `d` key in the top screen.

![Changing the refresh delay](/docs-images/changing_refresh_delay.gif)
...
![Changing the displayed fields](/docs-images/changing_displayed_fields.gif)
...
![Changing the sort field](/docs-images/changing_sort_field.gif)
...
![Changing the sort field](/docs-images/changing_order_of_fields.gif)
...
![Adding filters](/docs-images/adding_filters.gif)
...
![Showing and clearing filters](/docs-images/showing_and_clearing_filters.gif)
...
![Drilling down](/docs-images/driling_down.gif)

### Help screen

You can see the help screen by pressing `h` key in the top screen.

![Help screen](/docs-images/help_screen.gif)
