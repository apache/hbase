...
/**
 * A {@code Callback} for use by the {@code SaslServer} implementation when it needs to provide an
 * OAuth 2 bearer token compact serialization for validation. Callback handlers should use the
 * {@link #error(String, String, String)} method to communicate errors back to the SASL Client as
 * per <a href="https://tools.ietf.org/html/rfc6749#section-5.2">RFC 6749: The OAuth 2.0
 * Authorization Framework</a> and the <a href=
 * "https://www.iana.org/assignments/oauth-parameters/oauth-parameters.xhtml#extensions-error">IANA
 * OAuth Extensions Error Registry</a>. Callback handlers should communicate other problems by
 * raising an {@code IOException}.
 * <p>
...
public class OAuthBearerValidatorCallback implements Callback {
   ...
   * <a href="https://tools.ietf.org/html/rfc7628#section-3.2.2">RFC 7628: A Set of Simple
   * Authentication and Security Layer (SASL) Mechanisms for OAuth</a> and the <a href=
   * "https://www.iana.org/assignments/oauth-parameters/oauth-parameters.xhtml#extensions-error">IANA
   ...
   * <a href="https://tools.ietf.org/html/rfc7628#section-3.2.2">RFC 7628: A Set of Simple
   * Authentication and Security Layer (SASL) Mechanisms for OAuth</a>.
  ...
  /**
   * Set the error values as per <a href="https://tools.ietf.org/html/rfc7628#section-3.2.2">RFC
   * 7628: A Set of Simple Authentication and Security Layer (SASL) Mechanisms for OAuth</a>. Any
   * token is cleared.
   * <p/>
