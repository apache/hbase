...
public class TestPrefixFilterWithMiniCluster {
  ...
  public static final HBaseClassTestRule CLASS_RULE =
    HBaseClassTestRule.forClass(TestPrefixFilterWithMiniCluster.class);
  ...
  public void testNormalScanForwardsSeek() throws IOException {
    ...
    PrefixFilter filter = new PrefixFilter(Bytes.toBytes("testRowOne"));
    ...
    assertArrayEquals(ROWS_ONE, actualRows);
  }
  ...
  public void testReversedScanBackwardsSeek() throws IOException {
    ...
    Collections.reverse(actualRowsList);
    byte[][] actualRows = actualRowsList.toArray(new byte[][] {});
