...
put = TPut(row=b"row1", columnValues=[TColumnValue(family=b"family1",qualifier=b"qualifier1",value=b'100')])
print ("Putting:", put)
client.put(table, put)

tscan = TScan()
oscan = client.openScanner(table,tscan)
#r = client.getScannerRows(oscan,10)
r = client.getScannerResults(table,tscan,10)
client.closeScanner(oscan)
print ('result',r)
...
#deleting columns - qualifier unspecified entire family will be deleted
tdel = TDelete(row=b'row1',columns=[TColumn(family=b'family1',qualifier=b'qualifier1')])
client.deleteSingle(table,tdel)
