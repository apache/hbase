...
public interface MetricsRegionWrapper {
  ...
  /**
   * @return the max number of compactions queued for this region Note that this metric is updated
   *         periodically and hence might miss some data points
   */
  long getMaxCompactionQueueSize();

  /**
   * @return the max number of flushes queued for this region Note that this metric is updated
   *         periodically and hence might miss some data points
   */
